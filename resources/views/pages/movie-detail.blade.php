...
<body>
    <nav class="navbar">
        <div class="container-lg">
            <a class="navbar-brand" href="home"><img src="{{ url('assets/Logo.svg') }}" alt="Logo" style="height: 38px;"></a>
            <div class="d-flex gap-3">
                <a href="login" class="btn btn-outline-light border-secondary text-dark">Login</a>
        ...
        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-8 col-sm-6 box">
            ...
            <div class="font-size-18">
                <div class="d-flex gap-10" style="gap:10px; height:fit-content; ">
                    <span><b class="me-1">{{$movie['duration']}}</b> <b>Hour</b></span>
                    <span>•</span>
                    <div class="rating">
